...
class DQN:
    ...
    def __init__(self, n_actions, hidden=1024, learning_rate=0.00001, 
       ...
       """
        ...
        ## self.best_action is test time, for geting best action
        self.q_values = self.value + tf.subtract(self.advantage, tf.reduce_mean(self.advantage, axis=1, keepdims=True))
        ## argmax: return index i of this maximum element at axis 1, rely on shape of nparray
...
PATH = "output_gymDDQ_ori_190426/"                 # Gifs and checkpoints will be saved here
SUMMARIES = "summaries_ori_190426"          # logdir for tensorboard, run tensorboard 
RUNID = 'run_1'
    ...
    with tf.Session() as sess:        
        ...
        while frame_number < MAX_FRAMES:
            ...
            while epoch_frame < EVAL_FREQUENCY:
                ...
                ## save 
                episode_num+=1
                appenddata_csv(PATH+'/atari_'+ENV_NAME+'.csv', frame_number, episode_num, episode_reward_sum)
                
                episode_reward_sum = 0  # reset to 0
                
                ### if time_step <  MAX_EPISODE_LENGTH, or terminal==false
...
if TEST:
    ...
    print("model path: ",trained_path+save_file)
